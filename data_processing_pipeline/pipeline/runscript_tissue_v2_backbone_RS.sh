...
SASQ_PATH=/t1-data1/WTSA_Dev/rschwess/Sasquatch_offline/Sasquatch
...
IDTAG="Roadmap_Keratinocyte_rep1"
...
PEAK_FILE="/t1-data1/WTSA_Dev/rschwess/data_storage/DNase_for_CGAT/Keratinocyte-R1-DNase.bed"
...
### -----------------------------------------------------------------------------
### OPTIONAL filter regions file for ploidy regions (required bedtools installed)
### -----------------------------------------------------------------------------
