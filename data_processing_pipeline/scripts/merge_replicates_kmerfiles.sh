...
perl /t1-data1/WTSA_Dev/rschwess/scripts/dnase_tissue_motif/workflow/merge_replicates_kmerfiles.pl ${datadir}/${rep1}/counts/kmers_${i}_count_${rep1}_pnorm_JH60_plus.txt ${datadir}/${rep2}/counts/kmers_${i}_count_${rep2}_pnorm_JH60_plus.txt >kmers_${i}_count_${merged}_pnorm_JH60_plus.txt
...
perl /t1-data1/WTSA_Dev/rschwess/scripts/dnase_tissue_motif/workflow/merge_replicates_kmerfiles.pl ${datadir}/${rep1}/counts/kmers_${i}_count_${rep1}_pnorm_JH60_minus.txt ${datadir}/${rep2}/counts/kmers_${i}_count_${rep2}_pnorm_JH60_minus.txt >kmers_${i}_count_${merged}_pnorm_JH60_minus.txt
