...
##PLOTTING
	pp <- qplot(x=c(1:length(profile.plot.plus)),y=profile.plot.plus,geom='line', ylim=c(0,0.01), ylab="cut probability",main=paste0("Cut prob. profile ",kmer, ' #', count.plus)) + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash")
  
	pm <- qplot(x=c(1:length(profile.plot.minus)),y=profile.plot.minus,geom='line', ylim=c(0,0.01), ylab="cut probability",main=paste0("Cut prob. profile ",kmer, ' #', count.minus )) + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash")
...
hscorr <- function(kmer, profile, profile.naked, bandwidth, plotflag){
	...
	theplot <- ggplot(df, aes(x=x, y=value , group=species, colour=species),  xlab="bp idx", ylab="cut probability", main=paste0("Heavy Smoothed Profiles ",kmer)) + geom_line( ) + ylim(0,0.01)
...
print.base.comp <- function(kmer, bandwidth, a, c, g, t){
	...
	#plot
	pp <- ggplot(df, aes(x=idx, y=ratio, group=base, colour=base),  ylab="base frequency",  xlab="positon relative to kmer") + geom_line(size=0.7) + geom_vline(xintercept = 0, colour="black") + ylim(0.1, 0.6) + 
...
#plot		
		pp <- qplot(x=c(1:length(profile.plot.plus)), y=profile.plot.plus, geom='line', ylim=c(0,0.01), xlab="bp index", ylab="cut probability", main=paste0("Cut prob. profile ",kmer,' #',count.plus)) + geom_vline(xintercept = c((us.border.plus+(us.range.plus/2)),ds.border.plus-(ds.range.plus/2)), colour="red") + geom_vline(xintercept = c((us.border.plus-(us.range.plus/2)),(ds.border.plus+(ds.range.plus/2))), colour="red", linetype = "longdash") + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash")  #+ geom_vline(xintercept = c((126-5),(126+kl-1+5)), colour="black", linetype = "dotted")
			
	}else{		#border could not be estimated

		pp <- qplot(x=c(1:length(profile.plot.plus)),y=profile.plot.plus,geom='line', ylim=c(0,0.01), xlab="bp index", ylab="cut probability",main=paste0("Cut prob. profile ",kmer)) + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash")
...
#plot		
		pm <- qplot(x=c(1:length(profile.plot.minus)),y=profile.plot.minus,geom='line', ylim=c(0,0.01), xlab="bp index", ylab="cut probability",main=paste0("Cut prob. profile ",kmer)) + geom_vline(xintercept = c((us.border.minus+(us.range.minus/2)),(ds.border.minus+(ds.range.plus/2))), colour="red") + geom_vline(xintercept = c((us.border.minus-(us.range.minus/2)),(kl-1+ds.border.minus+(ds.range.minus/2))), colour="red", linetype = "longdash") + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash")  #+ geom_vline(xintercept = c((126-5),(126+kl-1+5)), colour="black", linetype = "dotted")	#ylim=c(0,0.01)

	}else{		#border could not be estimated

		pm <- qplot(x=c(1:length(profile.plot.minus)),y=profile.plot.minus,geom='line', ylim=c(0,0.01), xlab="bp index", ylab="cut probability",main=paste0("Cut prob. profile ",kmer)) + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash")
...
##PLOTTING
	pp <- qplot(x=c(1:length(plotting.profile.plus)),y=plotting.profile.plus, geom='line', ylim=c(0,0.01), xlab="bp index", ylab="cut probability",main=paste0("Cut prob. profile ",kmer, ' #', count.plus)) + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash")
  
	pm <- qplot(x=c(1:length(plotting.profile.minus)),y=plotting.profile.minus, geom='line', ylim=c(0,0.01), xlab="bp index", ylab="cut probability",main=paste0("Cut prob. profile ",kmer, ' #', count.minus )) + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash")
...
#unlist borders from the function (get.fp) returned list #when using sobel add 5bp to estimate the peaks
		...
		ds.border.plus <- unlist(list.plus["ds"])
#plot		
		pp <- qplot(x=c(1:length(profile.norm.plus)),y=profile.norm.plus,geom='line', ylim=c(0,0.01), xlab="bp index", ylab="cut probability",main=paste0("Cut prob. profile ",kmer, ' norm.flag = ',norm.flag.plus)) + geom_vline(xintercept = c((us.border.plus+(us.range.plus/2)),ds.border.plus-(ds.range.plus/2)), colour="red") + geom_vline(xintercept = c((us.border.plus-(us.range.plus/2)),(ds.border.plus+(ds.range.plus/2))), colour="red", linetype = "longdash") + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash") + geom_vline(xintercept = c((126-extension),(126+kl-1+extension)), linetype = "dotted") 
			
	}else{		#border could not be estimated

		pp <- qplot(x=c(1:length(profile.norm.plus)),y=profile.norm.plus,geom='line', ylim=c(0,0.01),xlab="bp index", ylab="cut probability",main=paste0("Cut prob. profile ",kmer)) + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash") + geom_vline(xintercept = c((126-extension),(126+kl-1+extension)), linetype = "dotted")
...
#unlist borders from the function (get.fp) returned list #when using sobel add 5bp to estimate the peaks
#plot		
		pm <- qplot(x=c(1:length(profile.norm.minus)),y=profile.norm.minus,geom='line', ylim=c(0,0.01), xlab="bp index", ylab="cut probability",main=paste0("Cut prob. profile ",kmer, ' norm.flag = ',norm.flag.minus)) + geom_vline(xintercept = c((us.border.minus+(us.range.minus/2)),(ds.border.minus-(ds.range.plus/2))), colour="red") + geom_vline(xintercept = c((us.border.minus-(us.range.minus/2)),(ds.border.minus+(ds.range.minus/2))), colour="red", linetype = "longdash") + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash") + geom_vline(xintercept = c((126-extension),(126+kl-1+extension)), linetype = "dotted")

	}else{		#border could not be estimated

		pm <- qplot(x=c(1:length(profile.norm.minus)),y=profile.norm.minus,geom='line', ylim=c(0,0.01), ylab="cut probability", xlab="bp index", main=paste0("Cut prob. profile ",kmer)) + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash") + geom_vline(xintercept = c((126-extension),(126+kl-1+extension)), linetype = "dotted")
...
#OVERLAPPLOT Plus
pp <-ggplot(df, aes(x=x, y=value , group=kmer, colour=kmer)) + geom_line() + ylim(0,0.01) + labs(title=paste0(kmer1,' #', count.plus1 ,' norm.flag = ',norm.flag.plus1,' vs. ',kmer2, ' #', count.plus2,' norm.flag = ',norm.flag.plus2), x="bp idx", y="cut probability") + geom_vline(xintercept = c(126,(126+kl-1)), linetype = "longdash")
...
#OVERLAPPLOT Minus
pm <-ggplot(df, aes(x=x, y=value , group=kmer, colour=kmer)) + geom_line( ) + ylim(0,0.01)  + labs(title=paste0(kmer1,' #', count.minus1 ,' norm.flag = ',norm.flag.minus1,' vs. ',kmer2, ' #', count.minus2,' norm.flag = ',norm.flag.minus2), x="bp idx", y="cut probability") + geom_vline(xintercept = c(126,(126+kl-1)), linetype = "longdash")
...
#OVERLAPPLOT Plus
pp <-ggplot(df, aes(x=x, y=value , group=kmer, colour=kmer)) + geom_line() + ylim(0,0.01) + labs(title=paste0(kmer1,' #', count.plus1,' vs. ',kmer2, ' #', count.plus2), x="bp idx", y="cut probability") + geom_vline(xintercept = c(126,(126+kl-1)), linetype = "longdash")
...
#OVERLAPPLOT Minus
pm <-ggplot(df, aes(x=x, y=value , group=kmer, colour=kmer)) + geom_line( ) + ylim(0,0.01)  + labs(title=paste0(kmer1,' #', count.minus1 ,' vs. ',kmer2, ' #', count.minus2), x="bp idx", y="cut probability") + geom_vline(xintercept = c(126,(126+kl-1)), linetype = "longdash")
...
##PLOTTING
	if(border.flag.plus){	#border could be estimated
		...
		ds.border.plus <- unlist(list.plus["ds"])
#plot		
		pp <- qplot(x=c(1:length(profile.plot.plus)), y=profile.plot.plus, geom='line', ylim=c(0,0.01), xlab="bp index", ylab="cut probability", main=paste0("Norm Cut prob. profile ",kmer,' #',count.plus)) + geom_vline(xintercept = c((us.border.plus+(us.range.plus/2)),ds.border.plus-(ds.range.plus/2)), colour="red") + geom_vline(xintercept = c((us.border.plus-(us.range.plus/2)),(ds.border.plus+(ds.range.plus/2))), colour="red", linetype = "longdash") + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash")  #+ geom_vline(xintercept = c((126-5),(126+kl-1+5)), colour="black", linetype = "dotted")
			
	}else{		#border could not be estimated

		pp <- qplot(x=c(1:length(profile.plot.plus)),y=profile.plot.plus,geom='line', ylim=c(0,0.01), xlab="bp index", ylab="cut probability",main=paste0("Norm Cut prob. profile ",kmer)) + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash")
...
#unlist borders from the function (get.fp) returned list #when using sobel add 5bp to estimate the peaks
#plot		
		pm <- qplot(x=c(1:length(profile.plot.minus)),y=profile.plot.minus,geom='line', ylim=c(0,0.01), xlab="bp index", ylab="cut probability",main=paste0("Norm Cut prob. profile ",kmer)) + geom_vline(xintercept = c((us.border.minus+(us.range.minus/2)),(ds.border.minus+(ds.range.plus/2))), colour="red") + geom_vline(xintercept = c((us.border.minus-(us.range.minus/2)),(kl-1+ds.border.minus+(ds.range.minus/2))), colour="red", linetype = "longdash") + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash")  #+ geom_vline(xintercept = c((126-5),(126+kl-1+5)), colour="black", linetype = "dotted")	#ylim=c(0,0.01)

	}else{		#border could not be estimated

		pm <- qplot(x=c(1:length(profile.plot.minus)),y=profile.plot.minus,geom='line', ylim=c(0,0.01), xlab="bp index", ylab="cut probability",main=paste0("Norm Cut prob. profile ",kmer)) + geom_vline(xintercept = c((126),(126+kl-1)), linetype = "longdash")
