...
#print Ref Var 
cat( paste( as.character(out.tab$sequence[1]), as.character(out.tab$sequence[2]), as.character(ref.tag), as.character(var.tag), as.numeric(ref.fsr), as.numeric(var.fsr), as.numeric(out.tab[2,dim(out.tab)[2]]), sep="\t"))
