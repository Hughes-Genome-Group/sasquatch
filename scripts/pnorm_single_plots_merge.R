...
source(args[6])	#get common functions from file
...
smooth.flag <- args[4]	#to smooth or not to smooth
...
#make plots in lists
profile.norm.list <- plot.profile.pnorm.data.single(kmer, profile.plus=profile.plus, count.plus=count.plus, smooth.flag=smooth.flag)
...
#plus
png.file=paste0(plot.dir,'/norm_data_plot_',kmer,'_merged.png')
