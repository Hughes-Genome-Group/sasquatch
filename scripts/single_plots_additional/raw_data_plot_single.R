...
#plus
png.file=paste0(plot.dir,'/raw_data_plot_',kmer,'_plus.png')
png(png.file, width=900, height=300)

		print( profile.raw.list$pp )	#real

suppress.output <- dev.off()

#minus
png.file=paste0(plot.dir,'/raw_data_plot_',kmer,'_minus.png')
png(png.file, width=900, height=300)


		print( profile.raw.list$pm )	#real
