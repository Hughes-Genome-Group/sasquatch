...
#qsub /t1-data1/WTSA_Dev/rschwess/Sasquatch_offline/Sasquatch/workflow_scripts/merged/in_silico_mutagenesis_pnorm_merged.sh
...
OUTPUT_DIR=/t1-data1/WTSA_Dev/rschwess/dnase_motif_tissue/validate_snps/QTL_GM12878/w4_min_test
...
wrapper_dmg_outlist=${OUTPUT_DIR}/summary_dmg_table_min.txt
