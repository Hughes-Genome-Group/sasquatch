...
#qsub/hts/data4/rschwess/Sasquatch_offline/Sasquatch/workflow_scripts/merged/in_silico_mutagenesis_pnorm_merged_summing_up.sh
...
OUTPUT_DIR=/hts/data4/rschwess/dnase_motif_tissue/validate_snps/QTL_GM12878/w4_summing_up_min_test
