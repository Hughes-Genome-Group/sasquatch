...
wrapper_dmg_outlist=${OUTPUT_DIR}/summary_dmg_table_sum.txt
...
then
	...
	Rscript ${SCRIPT_DIR}/quick.jaspar.query.R ${OUTPUT_DIR}/ordered ${OUTPUT_DIR}/ordered.jsp $ORGANISM ${JSP_THRESH}
